...
function addList (weatherTemp, weatherId){
	...
	$.ajax({
		...
		success: function(data) {
			var y = "";
			data.forEach(( i)=>{
			 y += '<div class="col-md-4"><p><a href="/product/detail?productId=' + i.productId + '"><img style="width: 300px; height: 300px;" class="img-thumbnail" alt="" src="./resources/images/' +i.filename + '"></a></p><p>상품이름: ' + i.pname + '</p><p>' + i.price + '</div>'   
			   } )
