...
<!--   <nav class="py-2 bg-light border-bottom"> -->
      <ul class="nav font-noto border-bottom">
        <li class="nav-item"><a href="#" class="nav-link link-light pl-5 text-dark" >로그인</a></li>
        <li class="nav-item"><a href="#" class="nav-link pl-2 text-dark">회원가입</a></li>
      </ul>
<!--   </nav> -->
  <header class="py-3 border-bottom">
    <div class="container d-flex flex-wrap justify-content-center">
      <a href="/" class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto text-dark text-decoration-none font-gamja nav-link link-light">
	...
	<ul class="nav nav-pills nav-fill sticky-top font-noto border-bottom" >
		<li class="nav-item"><a class="nav-link" style="color : black;" aria-current="page"
